...
The application deliberately avoids presenting a planning calculator as a real training run. The following product claims were rechecked against first-party documentation before v1.0.0:
